...
export default class waiterFeed extends Component  {
...
updateRes=(item)=>{
  ...
  this.props.navigation.navigate('waiterupdateResInfo', {resid: item});
}
...
>
 ...
 {/* <View>
                <TouchableOpacity style={styles.btnLoginn}
                  onPress={() => this.props.navigation.navigate('waiterDetail')}
                  >
