...
export default class adminreply extends Component  {
    ...
    // let userId = this.state.currentUserid
          ...
          const updatemessagestatus = db.collection("messages").doc(messageid)
    ...
    starsRef.getDownloadURL().then(url => {
       this.setState({ dp:url} )
          ...
          handleReplyMessage = (item) => {
            this.props.navigation.navigate('adminSendMessage', {userrid: item});
          }
                  ...
                  <StatusBar backgroundColor='#b3a7a9' barStyle="light-content"/>
                    ...
                    <View style={styles.sectionone}>
                                ...
                                <View style={styles.holder}>
                                        ...
                                        <Text style={styles.innerresb} >from: {this.state.senderfirstName} {this.state.senderlastName}</Text>
                                        </View>
                     ...
                     <View style={styles.opholder}>
                      ...
                      <TouchableOpacity style={styles.btncanclea}
                              onPress={ this.handleReplyMessage.bind(this, this.state.senderID) }
                           >
