...
adminread=(item)=>{
  // this.props.navigation.setParams({ name: item })
  this.props.navigation.navigate('adminreply', {messageid: item});
}

adminReadsent=(item)=>{
  // this.props.navigation.setParams({ name: item })
  this.props.navigation.navigate('adminReadsent', {messageid: item});
}
...
<TouchableOpacity 
                          ...
                          onPress={ this.adminread.bind(this, item.itemId) }
                          >
...
<TouchableOpacity 
                          // onPress={ this.cancleRes.bind(this, item.itemId) }
                          onPress={ this.adminReadsent.bind(this, item.itemId) }
                          >
