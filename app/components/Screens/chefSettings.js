...
export default class chefSettings extends Component  {
...
<View style={styles.container}>
                   ...
                   <View style={styles.resconb}>
                            ...
                            <View style={styles.resconbb}>
                                <TouchableOpacity style={styles.btncanclea}  
                                     onPress={ this.chefupdatefooditem.bind(this, item.itemId) }
              ...
              <TouchableOpacity style={styles.btnfoot}
                 onPress={() => this.props.navigation.navigate('chefaddfoodItem')}>
