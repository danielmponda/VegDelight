...
export default class cusChangePassword extends Component  {
    ...
    constructor(props) {
      super()
        ...
        const form = this.state.kaya ?  (<Text></Text> ) : (  
          <View>                    
        <View style={styles.sectionone}>
          ...
          {/* <Text style={styles.profileinfo}>Gender: {this.state.gender} </Text> */}
                                  ...
                                  <TouchableOpacity style={styles.usertype}
                                            onPress={() => this.props.navigation.navigate('cusChangeUserType')}
                                        >
                                        <Text style={styles.btnTexthf}>User Type</Text>
                                    </TouchableOpacity>
                                               </View>
        ...
        const changeform = this.state.changepasswordloading ?  (
          <View  style={styles.changepasswordloading}>
                 <ActivityIndicator animating={this.state.changepasswordloading} /> 
