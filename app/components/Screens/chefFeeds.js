...
export default class chefFeed extends Component  {
...
updateRes=(item)=>{
  ...
  this.props.navigation.navigate('chefupdateResInfo', {resid: item});
}
...
>
 ...
 <View>
                <TouchableOpacity style={styles.btnLoginn}
                  onPress={() => this.props.navigation.navigate('chefDetail')}
                  >
