...
export default class adminCart extends Component  {
    ...
    // Method of capturing preparedItems
            preparedItems = () => { 
      ...
      // Method of capturing requestedItems
          requestedItems = () => { 
 ...
 // Method of capturing reservation
reservation = () => { 
...
// Method of capturing CancelledreOrder
CancelledreOrder = () => { 
  this.setState({
...
// Method of storing preparedItems
