...
export default class chefChangePassword extends Component  {
...
{/* <Text style={styles.profileinfo}>Gender: {this.state.gender} </Text> */}
                    ...
                    <TouchableOpacity style={styles.btncanclea}
                            onPress={() => this.props.navigation.navigate('chefupdateUserInfo')}>
                ...
                <View style={styles.resconbb}>
                    <TouchableOpacity style={styles.btncanclea}
                             onPress={() => this.props.navigation.navigate('chefupdateUserEmailorPass')} >
